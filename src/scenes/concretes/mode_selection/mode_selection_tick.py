...
class ModeSelectionSceneTick(ITick):
    ...
    def select_option(self, set_next_scene: Callable[[IScene], None], dispatcher: Dict[SceneAction, Callable[[], None]]):
        selected_option = self.render.get_selected_option()
        ...
        if selected == "Quit":  # type: ignore
            ...
            set_next_scene(TransitionLevelScene(HeroType.CUMPA, World.ONE, Level.FIRST))
