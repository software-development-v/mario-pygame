...
class Button:
    def __init__(self, text: str, font: pygame.font.Font, position: Tuple[int, int], selected_color: Tuple[int, int, int], normal_color: Tuple[int, int, int]) -> None:
        self.text = text
        self.font = font
    ...
    def update_image(self):
        ...
        self.image = pygame.transform.scale(self.image, (text_rect.width + 30, text_rect.height + 20))
        self.rect = self.image.get_rect(center=self.position)
