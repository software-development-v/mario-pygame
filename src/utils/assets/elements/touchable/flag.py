...
FLAG_SUPPORT_1 = transform.scale(
    image.load(FLAG_SUPPORT_DIR + "support_stand_1.png"), (50, 50)
)
FLAG_SUPPORT_2 = transform.scale(
    image.load(FLAG_SUPPORT_DIR + "support_stand_2.png"), (50, 50)
)
FLAG_SUPPORT_3 = transform.scale(
    image.load(FLAG_SUPPORT_DIR + "support_stand_3.png"), (50, 50)
)
