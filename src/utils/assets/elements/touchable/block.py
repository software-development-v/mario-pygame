...
from src.utils.directories import BRICK_DIR, WALL_DIR, MYSTERY_BLOCK_DIR,TERRAIN_DIR
...
OVERWORLD_TERRAIN_BLOCK  = transform.scale(
    image.load(TERRAIN_DIR + "overworld.png"), GENERAL_SIZE
)
